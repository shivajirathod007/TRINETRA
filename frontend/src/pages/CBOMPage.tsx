  ...
  return (
    <div className="flex flex-col gap-6 max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold font-outfit" style={{ color: 'var(--text-primary)', letterSpacing: '-0.01em' }}>Cryptographic Bill of Materials</h1>
          <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>CycloneDX 1.6 CBOM — PQC Readiness Intelligence</p>
        </div>
